...
For exact reproducibility, a Docker image is provided:
...
This reproduces Tables 3–5 and 7–9 from source. The Docker image pins OpenModelica 1.22.3 and Modelica Standard Library 4.0.0.

Documentation includes: (a) README with quick-start guide, (b) API reference auto-generated from Modelica annotations using MoDoc, (c) three Jupyter notebook tutorials (dual-tank assembly, flume DMPC, FMI export to Python).
