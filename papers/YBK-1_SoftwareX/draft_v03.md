...
A Docker image with MATLAB Runtime is provided for non-licensed users (limited to SiL verification). An archival snapshot is deposited on Zenodo (DOI: 10.5281/zenodo.XXXXXXX, to be minted upon acceptance) under MIT license.
