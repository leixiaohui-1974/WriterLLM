...
## 0.1 Key claims and evidence status (v09)

| Claim | Type | Evidence status in v09 |
|---|---|---|
...
Current state: **pre-submission** until external reference verification is completed.
