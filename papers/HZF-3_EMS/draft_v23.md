...
## 0.1 Key claims and evidence status (v23)

| Claim | Type | Evidence status in v23 |
|---|---|---|
...
The consistency artifact must include `current_draft: "draft_v23.md"`, and all version-sensitive checks (including evidence freshness) must resolve against this pointer to avoid stale literal references after version bumps.
...
### 7.11 Fingerprint canonicalization rule (v23)
