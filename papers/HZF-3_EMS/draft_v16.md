...
For each release, `cross_paper_consistency_hzf3.json.consistency_checks[*].evidence` must reference the current draft version (e.g., `draft_v16.md`) rather than older snapshots, ensuring version-synchronous audit trails.
