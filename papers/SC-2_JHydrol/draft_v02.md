...
__*Table 13. Field-Scale Toolchain Extrapolation*__

| System | Pools | FMU Compile [s] | DMPC Solve [ms] | ST Lines [k] | PLC Memory [MB] | PLC Target |
|--------|-------|-----------------|-----------------|--------------|-----------------|------------|
| Lab flume | 5 | 45 | 5.8 | 12 | 1.2 | S7-1200 |
| Small canal | 10 | 90 | 15 | 24 | 2.4 | S7-1200 |
| Medium canal | 50 | 450 | 500 | 120 | 12 | S7-1500 |
| Large canal | 100 | 900 | 2,500 | 240 | 24 | Multi-PLC |

For 100-pool systems, the DMPC solve time (2.5 s) approaches the 5-s sampling interval. GPU-parallel ADMM (Huang et al., 2026) or hierarchical DMPC decomposition would be necessary.

__*Table 5b. FMI Communication Step-Size Sensitivity (MiL, 20 nominal scenarios)*__

| Step Size [s] | MiL RMSE [mm] | FMU Eval Time [ms] | $\Delta$ from Baseline | Stable? |
|---------------|--------------|---------------------|------------------------|---------|
| 0.5 | 3.05 | 0.8 | −0.05 | Yes |
| 1.0 (baseline) | 3.10 | 1.5 | — | Yes |
| 2.0 | 3.25 | 2.8 | +0.15 | Yes |
| 5.0 | 4.15 | 6.5 | +1.05 | Yes (marginal) |

__*Table 14. PLC Resource Profile (Five-Pool DMPC on S7-1200)*__

| Resource | Used | Available | Utilization |
|----------|------|-----------|-------------|
| Work memory | 38 KB | 100 KB | 38% |
| Load memory | 1.2 MB | 4 MB | 30% |
| CPU (100 ms cycle) | 12% | 100% | 12% |
| OPC-UA bandwidth | 2.4 KB/s | 100 Mbps | <0.01% |
